                ...
                //======== loginTab ========
                {
                    ...
                    //======== inputPanel ========
                    {
                        ...
                        //======== loginPanel ========
                        {
                            ...
                            //---- loginLabel ----
                            loginLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.login"));
                        ...
                        //======== pwdPanel ========
                        {
                            ...
                            //---- pwdLabel ----
                            pwdLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.password"));
                    ...
                    //======== buttonPanel ========
                    {
                        ...
                        //---- loginButton ----
                        loginButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.login"));
...
//
                ...
                tabbedPane.addTab(MessageManager.getInstance().getLocalMessages().getString("tab.login"), loginTab);
                ...
                //======== registerTab ========
                {
                    ...
                    //======== buttonRegisterPanel ========
                    {
                        ...
                        //---- registerButton ----
                        registerButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.register"));
                        buttonRegisterPanel.add(registerButton);

                        //---- cancelRegisterButton ----
                        cancelRegisterButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.exit"));
                    ...
                    //======== inputRegisterPanel ========
                    {
                        ...
                        //======== loginRegisterPanel ========
                        {
                            ...
                            //---- loginRegisterLabel ----
                            loginRegisterLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.login"));
                        ...
                        //======== pwdRegisterPanel ========
                        {
                            ...
                            //---- pwdRegisterLabel ----
                            pwdRegisterLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.password"));
                        ...
                        //======== repeatPwdPanel ========
                        {
                            ...
                            //---- repeatPwdLabel ----
                            repeatPwdLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.repeat_password"));
                ...
                tabbedPane.addTab(MessageManager.getInstance().getLocalMessages().getString("tab.register"), registerTab);
            }
            add(tabbedPane);
        }
    }
    ...
    public void setTexts(){
        tabbedPane.setTitleAt(0, MessageManager.getInstance().getLocalMessages().getString("tab.login"));
        tabbedPane.setTitleAt(1, MessageManager.getInstance().getLocalMessages().getString("tab.register"));
        loginLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.login"));
        pwdLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.password"));
        loginButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.login"));
        cancelButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.cancel"));
        ...
        repeatPwdLabel.setText(MessageManager.getInstance().getLocalMessages().getString("label.repeat_password"));
        registerButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.register"));
        cancelRegisterButton.setText(MessageManager.getInstance().getLocalMessages().getString("button.cancel"));
    }
}
