...
//класс для того, чтобы производить выполнение скрипта из файла на создание и добавление автомобиля
public class AskerFile extends Asker{
    public AskerFile(Scanner userScanner) {
        super(userScanner);
    }
